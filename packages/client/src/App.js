...
function App() {
  ...
  // コントラクトアドレスを記載
  const daiTokenAddress = '0x597020d7fA0111F7eF1d779731C41185F7dA2bB1';
  const dappTokenAddress = '0xcD09b426B34A0469a3320eB7BD3dD837DbE9583F';
  const tokenfarmAddress = '0x2b28127B85D361BF679dfD37b30C2588C0D3d104';

  //ウォレットアドレス(コントラクトの保持者)を記載
  const walletAddress = '0xE5807209E70A0f74CE2b8aB34d5861C461468B2c';
